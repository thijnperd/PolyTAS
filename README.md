...
## Overview
PolyTAS is a desktop app (Electron) with an embedded game view, live input editing, and instant replay previews.
...
- Replay inputs directly inside the embedded game view.
...
5. Use RUN REPLAY to replay inputs.
